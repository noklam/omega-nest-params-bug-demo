...
# omega_nest_param documentation build
...
from omega_nest_param import __version__ as release

# -- Project information -----------------------------------------------------

project = "omega_nest_param"
author = "Kedro"
...
htmlhelp_basename = "omega_nest_paramdoc"
...
latex_documents = [
    (
        master_doc,
        "omega_nest_param.tex",
        "omega_nest_param Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "omega_nest_param",
        "Project omega_nest_param codebase.",
        "Nearest-Neighbour",
    )
]
